...
console.log("ride :",ride)
  return (
    <div className='h-screen'>
        <Link to='/home' className='fixed w-10 flex justify-center items-center h-10 right-2 top-2 rounded-full bg-white'>
 ...
 <LiveTracking/>
        ...
        <div className='flex justify-between  items-center flex-wrap'>
           ...
           <div className=''> 
            <h3 className='text-lg text-gray-800 w-full text-end font-bold'>{ride.captain.fullname}</h3>
            <h2 className='font-medium text-gray-600 text-lg text-end w-full'> {ride.captain.vehicle.plateNumber}</h2>
            <p className='text-gray-400 text-sm'>{ride.captain.vehicle.color}, Maruti suzuki Baleno</p>
            </div>
           </div>
            ...
            <div>
             ...
             <p className='text-sm text-gray-600'>Cash Cash</p>
                ...
                <button className='w-full text-2xl text-white bg-green-500 rounded-xl font-light py-2 mt-5'>Make a Payment</button>
        </div>
    </div>
  )
}
