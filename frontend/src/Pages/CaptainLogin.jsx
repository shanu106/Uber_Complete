...
const CaptainLogin = () => {
   ...
   console.log(response)
    if(response.status==200 || response.status == 201){
      ...
      // setCaptain({fullname:data.captain.fullname})
